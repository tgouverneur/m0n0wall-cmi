...
<table width="90%" border="0" cellspacing="0" cellpadding="2">
  <tr valign="bottom"> 
    <td width="20%" height="65" align="center" valign="middle"> <strong><img src="./img/logo.gif" width="150" height="47" border="0"></strong></td>
	...
	<tr><td align="left" valign="bottom"><span class="tfrtitle">&nbsp;Central Management Interface
	  ...
	  <span class="hostname"><?php echo $pagename; ?>&nbsp;</span>
	  </td></tr></table>
	</td>
  </tr>
  <tr valign="top"> 
